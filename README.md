...
Voici la liste des codes d'erreur que le programme peut renvoyer. Cependant,
comme toutes les options de la librairie ne sont pas utilisées, la plupart
des erreurs n'arriveront jamais.
